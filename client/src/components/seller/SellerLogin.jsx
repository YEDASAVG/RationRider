...
const SellerLogin = () => {
  ...
  return !isSeller && (
    <form onSubmit={onSubmitHandler} className="min-h-screen flex items-center text-sm text-gray-600">
        <div className="flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200 ">
            ...
            <button className='bg-primary text-white rounded-md w-full py-2 cursor-pointer hover:bg-primary-dull transition-all'>Login</button>
        </div>
    </form>
  )
}
